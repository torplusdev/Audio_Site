...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Wp_Forms_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://qodeinteractive.com/qi-addons-for-elementor/wp-forms/' );
			...
			$this->set_option(
				array(
					...
					'selector'   => '{{WRAPPER}} .qodef-qi-wp-forms input:not([type=submit]), {{WRAPPER}} .qodef-qi-wp-forms textarea, {{WRAPPER}} .qodef-qi-wp-forms select',
					'group'      => esc_html__( 'Input Style', 'qi-addons-for-elementor' ),
				)
			);
			$this->set_option(
			...
			$this->set_option(
				array(
					...
					'selector'   => '{{WRAPPER}} .qodef-qi-wp-forms input:not([type=submit]):focus, {{WRAPPER}} .qodef-qi-wp-forms textarea:focus',
					'group'      => esc_html__( 'Input Style', 'qi-addons-for-elementor' ),
				)
			);
			$this->set_option(
