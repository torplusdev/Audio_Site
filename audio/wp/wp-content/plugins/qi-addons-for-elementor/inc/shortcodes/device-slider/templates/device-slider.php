<div <?php qi_addons_for_elementor_framework_class_attribute( $holder_classes ); ?>>
	...
	<div class="qodef-m-items">
		<div <?php qi_addons_for_elementor_framework_class_attribute( $slider_classes ); ?> <?php qi_addons_for_elementor_framework_inline_attr( $slider_attr, 'data-options' ); ?>>
			...
			<?php
			if ( 'inside' === $slider_navigation_position || 'together' === $slider_navigation_position ) {
		...
		<?php
		if ( 'outside' === $slider_navigation_position ) {
			qi_addons_for_elementor_template_part( 'content', 'templates/swiper-nav', $slider_navigation_position, $params );
		}
		?>
	</div>
</div>
