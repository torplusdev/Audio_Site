		...
		public function map_shortcode() {
				...
				array(
					...
					'items'         => array(
						...
						array(
							...
							'default_value' => 'left',
							'description'   => esc_html__( 'This option affects only standard layout', 'qi-addons-for-elementor' ),
						),
						array(
			...
			$this->set_option(
				array(
					...
					'responsive' => true,
					'selectors'  => array(
						'{{WRAPPER}} .qodef-e-title:after' => 'height: {{VALUE}}px;',
					),
					'group'      => esc_html__( 'Hover Style', 'qi-addons-for-elementor' ),
				)
			);
			...
			$this->set_option(
				array(
					...
					'responsive' => true,
					'selectors'  => array(
						'{{WRAPPER}} .qodef-hover--line-through .qodef-e-title:after' => 'top: calc(50% - {{VALUE}}px);',
						'{{WRAPPER}} .qodef-hover--underline .qodef-e-title:after'    => 'bottom: {{VALUE}}px;',
					),
					'group'      => esc_html__( 'Hover Style', 'qi-addons-for-elementor' ),
				)
			);
