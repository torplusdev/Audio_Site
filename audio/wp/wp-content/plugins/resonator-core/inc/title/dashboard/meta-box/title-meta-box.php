...
if ( ! function_exists( 'resonator_core_add_page_title_meta_box' ) ) {
	/**
	 * Function that add general meta box options for this module
	 *
	 * @param object $page
	 */
	function resonator_core_add_page_title_meta_box( $page ) {
		...
		if ( $page ) {
			...
			$title_tab = $page->add_tab_element(
				array(
					...
					'description' => esc_html__( 'Title layout settings', 'resonator-core' )
				)
			);
			...
			$page_title_section->add_field_element(
				array(
					...
					'options'     => apply_filters( 'resonator_core_filter_title_layout_options', $layouts = array( '' => esc_html__( 'Default', 'resonator-core' ) ) )
				)
			);
			...
			do_action( 'resonator_core_action_after_page_title_meta_box_map', $page_title_section );
		}
	}

	add_action( 'resonator_core_action_after_general_meta_box_map', 'resonator_core_add_page_title_meta_box' );
}

if ( ! function_exists( 'resonator_core_add_general_page_title_meta_box_callback' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_core_add_general_page_title_meta_box_callback( $callbacks ) {
		$callbacks['page-title'] = 'resonator_core_add_page_title_meta_box';
		
		return $callbacks;
	}
	
	add_filter( 'resonator_core_filter_general_meta_box_callbacks', 'resonator_core_add_general_page_title_meta_box_callback');
}