...
if ( ! class_exists( 'ResonatorCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class ResonatorCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'resonator-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'resonator_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	ResonatorCoreDashboardRestAPI::get_instance();
}
