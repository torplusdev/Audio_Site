...
if ( ! function_exists( 'resonator_core_register_fullscreen_menu' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_core_register_fullscreen_menu( $menus ) {
		$menus['fullscreen-menu-navigation'] = esc_html__( 'Fullscreen Navigation', 'resonator-core' );
		
		return $menus;
	}
	
	add_filter( 'resonator_filter_register_navigation_menus', 'resonator_core_register_fullscreen_menu' );
}

if ( ! function_exists( 'resonator_core_set_fullscreen_menu_typography_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function resonator_core_set_fullscreen_menu_typography_styles( $style ) {
		$scope = RESONATOR_CORE_OPTIONS_NAME;
		
		$first_lvl_styles        = resonator_core_get_typography_styles( $scope, 'qodef_fullscreen_1st_lvl' );
		$first_lvl_hover_styles  = resonator_core_get_typography_hover_styles( $scope, 'qodef_fullscreen_1st_lvl' );
		$second_lvl_styles       = resonator_core_get_typography_styles( $scope, 'qodef_fullscreen_2nd_lvl' );
		$second_lvl_hover_styles = resonator_core_get_typography_hover_styles( $scope, 'qodef_fullscreen_2nd_lvl' );
		...
		$first_lvl_active_color = resonator_core_get_option_value( 'admin', 'qodef_fullscreen_1st_lvl_active_color' );
		...
		$second_lvl_active_color = resonator_core_get_option_value( 'admin', 'qodef_fullscreen_2nd_lvl_active_color' );
	...
	add_filter( 'resonator_filter_add_inline_style', 'resonator_core_set_fullscreen_menu_typography_styles' );
}