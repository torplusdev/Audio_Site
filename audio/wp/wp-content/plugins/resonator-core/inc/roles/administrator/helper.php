...
if ( ! function_exists( 'resonator_core_add_administrator_role_caps' ) ) {
	/**
	 * Function that add user role capabilities for custom post types
	 */
	function resonator_core_add_administrator_role_caps() {
		
		// Add the roles you'd like to administer the custom post types
		$roles = apply_filters( 'resonator_core_filter_administrator_roles', array( 'editor', 'administrator' ) );
		
		// Allowed custom post types
		$cpt_items = apply_filters( 'resonator_core_filter_administrator_cpts', array() );
	...
	add_action( 'resonator_core_action_plugin_loaded', 'resonator_core_add_administrator_role_caps' );
}