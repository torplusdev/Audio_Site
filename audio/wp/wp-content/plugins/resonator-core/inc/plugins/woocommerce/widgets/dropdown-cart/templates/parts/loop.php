		...
		if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
			...
			<div class="qodef-woo-dropdown-item qodef-e">
				...
				<div class="qodef-e-content">
					...
					<p class="qodef-e-quantity"><?php echo esc_attr( $cart_item['quantity'] ); ?></p><span class="qodef-e-separator"><?php echo esc_attr__( ' x', 'resonator-core' ); ?></span>
					...
					<?php echo sprintf( '<a href="%s" class="qodef-e-remove remove" title="%s">%s</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_attr__( 'Remove this item', 'resonator-core' ), qode_framework_icons()->render_icon( 'ion-md-close', 'ionicons' ) ); ?>
				</div>
			</div>
		<?php }
	} ?>
