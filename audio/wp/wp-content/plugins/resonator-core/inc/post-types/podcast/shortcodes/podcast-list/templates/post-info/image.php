<?php
$podcast_list_image = get_post_meta( get_the_ID(), 'qodef_podcast_list_image', true );
$has_image            = ! empty ( $podcast_list_image ) || has_post_thumbnail();
...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image">
		...
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php echo resonator_core_get_list_shortcode_item_image( $image_dimension, $podcast_list_image, $custom_image_width, $custom_image_height ); ?>
		</a>
	</div>
<?php } ?>