...
if ( ! function_exists( 'resonator_core_add_standard_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function resonator_core_add_standard_mobile_header_options( $page, $general_tab ) {
		
		$section = $general_tab->add_section_element(
			array(
				'name'       => 'qodef_standard_mobile_header_section',
				'title'      => esc_html__( 'Standard Mobile Header', 'resonator-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'resonator_core_action_after_mobile_header_options_map', 'resonator_core_add_standard_mobile_header_options', 10, 2 );
}