...
if ( ! function_exists( 'resonator_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'ResonatorCoreFontAwesomePack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'resonator_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ResonatorCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return RESONATOR_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function get_new_icons_list() {
			...
			if ( file_exists( RESONATOR_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( RESONATOR_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
