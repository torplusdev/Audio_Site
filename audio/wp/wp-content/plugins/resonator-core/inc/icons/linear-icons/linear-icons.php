...
if ( ! function_exists( 'resonator_core_add_linear_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_core_add_linear_icons_to_collection( $icons ) {
		$icons[] = 'ResonatorCoreLinearIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'resonator_core_add_linear_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ResonatorCoreLinearIconsPack extends QodeFrameworkIconPack {
