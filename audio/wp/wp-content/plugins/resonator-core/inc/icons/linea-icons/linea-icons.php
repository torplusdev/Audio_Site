...
if ( ! function_exists( 'resonator_core_add_linea_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_core_add_linea_icons_to_collection( $icons) {
		$icons[] = 'ResonatorCoreLineaIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'resonator_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ResonatorCoreLineaIconsPack extends QodeFrameworkIconPack {
