...
if ( ! function_exists( 'resonator_core_add_simple_line_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_core_add_simple_line_icons_to_collection( $icons ) {
		$icons[] = 'ResonatorCoreSimpleLineIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'resonator_core_add_simple_line_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ResonatorCoreSimpleLineIconsPack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return RESONATOR_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/' . $this->get_base() . '.min.css';
		}
