...
if ( ! class_exists( 'ResonatorCoreShortcodes' ) ) {
	class ResonatorCoreShortcodes {
		...
		function init() {
			...
			include_once RESONATOR_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once RESONATOR_CORE_SHORTCODES_PATH . '/shortcode.php';
			include_once RESONATOR_CORE_SHORTCODES_PATH . '/list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'resonator_core_filter_register_shortcodes', $shortcodes = array() );
	...
	ResonatorCoreShortcodes::get_instance();
}