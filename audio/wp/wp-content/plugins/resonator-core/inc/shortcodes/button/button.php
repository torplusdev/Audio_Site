...
if ( ! function_exists( 'resonator_core_add_button_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_core_add_button_shortcode( $shortcodes ) {
		$shortcodes[] = 'ResonatorCoreButtonShortcode';

		return $shortcodes;
	}

	add_filter( 'resonator_core_filter_register_shortcodes', 'resonator_core_add_button_shortcode', 9 );
}

if ( class_exists( 'ResonatorCoreShortcode' ) ) {
	class ResonatorCoreButtonShortcode extends ResonatorCoreShortcode {

		public function __construct() {
			$this->set_layouts( apply_filters( 'resonator_core_filter_button_layouts', array() ) );

			parent::__construct();
		}

		public function map_shortcode() {
			$this->set_shortcode_path( RESONATOR_CORE_SHORTCODES_URL_PATH . '/button' );
			$this->set_base( 'resonator_core_button' );
			$this->set_name( esc_html__( 'Button', 'resonator-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays button with provided parameters', 'resonator-core' ) );
			...
			$this->set_option( array(
				'field_type' => 'select',
				'name'       => 'size',
				'title'      => esc_html__( 'Size', 'resonator-core' ),
				'options'    => array(
					''      => esc_html__( 'Normal', 'resonator-core' ),
					'small' => esc_html__( 'Small', 'resonator-core' ),
					'large' => esc_html__( 'Large', 'resonator-core' ),
					'full'  => esc_html__( 'Normal Full Width', 'resonator-core' ),
				),
                'dependency' => array (
                    'hide' => array (
                        'button_layout' => array (
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'link',
				'title'      => esc_html__( 'Button Link', 'resonator-core' )
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'target',
				'title'         => esc_html__( 'Target', 'resonator-core' ),
			...
			$this->set_option( array(
				'name'       => 'hover_color',
				'field_type' => 'color',
				'title'      => esc_html__( 'Text Hover Color', 'resonator-core' ),
				'group'      => esc_html__( 'Style', 'resonator-core' )
			) );
			$this->set_option( array(
				'field_type' => 'color',
			...
			$this->set_option( array(
				...
				'title'      => esc_html__( 'Background Hover Color', 'resonator-core' ),
				'group'      => esc_html__( 'Style', 'resonator-core' )
			) );
			$this->set_option( array(
				'field_type' => 'color',
				'name'       => 'border_color',
				'title'      => esc_html__( 'Border Color', 'resonator-core' ),
				'group'      => esc_html__( 'Style', 'resonator-core' )
			) );
			$this->set_option( array(
				'field_type' => 'color',
				'name'       => 'hover_border_color',
				'title'      => esc_html__( 'Border Hover Color', 'resonator-core' ),
				'group'      => esc_html__( 'Style', 'resonator-core' )
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'margin',
				'title'      => esc_html__( 'Margin', 'resonator-core' ),
				'group'      => esc_html__( 'Style', 'resonator-core' )
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'padding',
				'title'      => esc_html__( 'Padding', 'resonator-core' ),
				'group'      => esc_html__( 'Style', 'resonator-core' )
			) );
			$this->set_option( array(
				'field_type' => 'text',
				...
				'group'      => esc_html__( 'Typography', 'resonator-core' )
			) );
			$this->set_option( array(
				'field_type' => 'select',
				'name'       => 'font_weight',
			...
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'html_type',
				'title'         => esc_html__( 'HTML Type', 'resonator-core' ),
				'options'       => array(
					'default' => esc_html__( 'Default', 'resonator-core' ),
					'input'   => esc_html__( 'Input', 'resonator-core' ),
					'submit'  => esc_html__( 'Submit', 'resonator-core' )
				),
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'input_name',
				'title'      => esc_html__( 'Input Name', 'resonator-core' ),
				'visibility'    => array(
					'map_for_page_builder'    => false
				)
			) );
			$this->set_option( array(
				'field_type' => 'array',
				'name'       => 'custom_attrs',
				'title'      => esc_html__( 'Custom Data Attributes', 'resonator-core' ),
				'visibility'    => array(
					'map_for_page_builder'    => false
				)
			) );
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'resonator_core_button', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return resonator_core_get_template_part( 'shortcodes/button', 'variations/'.$atts['button_layout'].'/templates/' . $atts['html_type'], '', $atts );
		}
