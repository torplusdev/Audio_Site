...
if ( ! function_exists( 'resonator_core_add_icon_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_core_add_icon_shortcode( $shortcodes ) {
		$shortcodes[] = 'ResonatorCoreIconShortcode';
		
		return $shortcodes;
	}
	
	add_filter( 'resonator_core_filter_register_shortcodes', 'resonator_core_add_icon_shortcode', 8 );
}

if ( class_exists( 'ResonatorCoreShortcode' ) ) {
	class ResonatorCoreIconShortcode extends ResonatorCoreShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( RESONATOR_CORE_SHORTCODES_URL_PATH . '/icon' );
			$this->set_base( 'resonator_core_icon' );
			$this->set_name( esc_html__( 'Icon', 'resonator-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds icon element', 'resonator-core' ) );
			...
			$this->set_option( array(
				...
				'options'    => array(
					...
					'tiny'    => esc_html__( 'Tiny', 'resonator-core' ),
					'small'   => esc_html__( 'Small', 'resonator-core' ),
					'medium'  => esc_html__( 'Medium', 'resonator-core' ),
					'large'   => esc_html__( 'Large', 'resonator-core' ),
					'huge'    => esc_html__( 'Huge', 'resonator-core' ),
				)
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'custom_size',
				'title'      => esc_html__( 'Custom Size', 'resonator-core' ),
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'icon_layout',
				...
				'options'       => array(
					'normal' => esc_html__( 'Normal', 'resonator-core' ),
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'border_radius',
				'title'      => esc_html__( 'Border Radius', 'resonator-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => 'square',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'shape_size',
				'title'      => esc_html__( 'Shape Size', 'resonator-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'border_width',
				'title'      => esc_html__( 'Border Width', 'resonator-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => array( 'circle', 'square' ),
            ...
            $this->set_option( array(
                ...
                'title'      => esc_html__( 'Vertical Offset', 'resonator-core' ),
            ) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'margin',
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'resonator_core_icon', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return resonator_core_get_template_part( 'shortcodes/icon', 'templates/icon', '', $atts );
		}
