...
if ( ! function_exists( 'resonator_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function resonator_get_filter_items( $params ) {
		...
		return apply_filters( 'resonator_filter_get_filter_items', $items, $params );
	}
}
